    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4 py-12 space-y-16">
        ...
        <section className="text-center space-y-8">
          <h1 className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-primary/80 animate-fade-in">
            Passion Varadero
          </h1>
        ...
        {/* Statistics Section avec style amélioré */}
        ...
        {/* About Section avec cartes interactives */}
        ...
        {/* Call to Action avec design attractif */}
