export const frenchTranslations = {
  ...
  approveTranslation: "Approuver la traduction",
  rejectTranslation: "Rejeter la traduction",
  ...
  translationError: "Une erreur est survenue lors de la modification de la traduction",
};
