export const frenchTranslations = {
  ...
  motivation: "Votre motivation pour devenir parrain",
  ...
  rejectionConfirmationMessage: "Êtes-vous sûr de vouloir refuser cette demande de parrainage ?",
  cancel: "Annuler",
  ...
  sponsorshipRequestRejected: "Demande de parrainage refusée",
  errorApprovingRequest: "Erreur lors de l'approbation de la demande",
  errorRejectingRequest: "Erreur lors du refus de la demande"
};